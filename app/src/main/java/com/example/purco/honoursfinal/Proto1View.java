...
class Proto1View extends GLSurfaceView {
    long timeCounter;
    private final Proto1Renderer mRenderer;
    String mode;

    private float[] previousArcBallCoord;
    private float[] currentArcBallCoord;

    public Proto1View(Context context){
        super(context);
        ...
        mRenderer = new Proto1Renderer(context);
        mode = "draw";
            ...
            if (mode.equals("draw")) {
                ...
                switch (e.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        requestRender();
                        // if(dx*dy >50000) {
                      //  if ( mRenderer.getLastLength()> 0.3||(System.nanoTime() - timeCounter) > 2000000000) {
                        if ( mRenderer.getLastLength()> 0.2) {
